...
protected:
    ...
    {
        virtual_pitch_offset_deg = target_pitch;
    ...
    float pitch_offset_deg; // physical pitch offset -> body to horizon
    float virtual_pitch_offset_deg; // virttual pitch offset -> thrust vector to horizon
